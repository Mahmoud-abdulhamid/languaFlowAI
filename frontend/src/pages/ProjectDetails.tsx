...
export const ProjectDetails = () => {
    ...
    return (
        <div className="min-h-screen text-foreground p-1 md:p-8 max-w-7xl mx-auto space-y-1 md:space-y-6">
            <button onClick={() => navigate('/projects')} className="flex items-center gap-2 text-muted hover:text-foreground transition-colors mb-1 md:mb-4">
                <ArrowLeft size={20} /> Back to Projects
            </button>

            {/* Project Header - Full Width */}
            <GlassCard className="p-1 md:p-8 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-1 md:space-y-6">

                    {/* Stats & Files Section */}
                    <GlassCard className="p-1 md:p-6 md:col-span-2 space-y-4 md:space-y-8">
                ...
                <div className="space-y-1 md:space-y-6">
                    ...
                    {/* Progress Widget */}
                    {progress && (
                        <GlassCard className="p-1 md:p-6">
